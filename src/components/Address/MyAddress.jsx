...
import { addressDelete, getAddress } from "../../Api Services/glowHttpServices/glowLoginHttpServices";
          ...
          <div className="row">
            ...
            <div className="col-lg-9 col-md-8 col-12">
              <div className>
                      ...
                      {myAddress?.map((item) => (
                        <div className="card-box">
                          <div className="border-bottom">
                            <button className="btn btn-dark mb-2">Default</button>
                            <p className="text text-dark fw-semibold"></p>
                            <p className="text-light mb-0">
                              {item?.street}
                            </p>
                            <p className="text-light mb-2">+{item?.countryCode} {item?.phoneNumber}</p>
                          </div>
                          <div className="d-flex gap-4 pt-2">
                            <button
                              className="bg-transparent text-danger fw-semibold"
                              data-toggle="modal"
                              data-target="#exampleModal" onClick={()=>handleDelete(item?._id)}
                            >
                              Delete
                            </button>
                            <button
                ...
                <div className="mt-4 ">
                  <div className="col-lg-12 col-md-12 col-12 text-center" style={{cursor:"pointer"}}>
                    <a href className="text-primary"  onClick={() => navigate("/edit-address")}>
                      + Add New Address
                    </a>
                  </div>
                </div>
